...
VALUES ('role_customer', 'customer', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT ("name") DO NOTHING;

INSERT INTO "permissions" ("id", "name", "createdAt")
VALUES ('perm_customer_profile', 'customer:profile:read', CURRENT_TIMESTAMP)
ON CONFLICT ("name") DO NOTHING;

INSERT INTO "role_permissions" ("roleId", "permissionId")
SELECT r."id", p."id"
FROM "roles" r, "permissions" p
WHERE r."name" = 'customer' AND p."name" = 'customer:profile:read'
